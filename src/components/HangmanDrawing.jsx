...
function HangmanDrawing({wrongLetters, isLoser,isWinner}) {
  return (
    <div className='hangmanDrawing'>
      ...
      <div className={isWinner || isLoser ? "hithere" : "right-arm"} style={{visibility: wrongLetters.length >= 7 ? "visible" : "hidden"}}></div>
